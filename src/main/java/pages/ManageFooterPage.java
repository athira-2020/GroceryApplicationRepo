...
public class ManageFooterPage {
	...
	@FindBy(xpath="//a[contains(@class,'small-box-footer') and contains(@href,'list-footertext')]")WebElement buttonMoreInfo;
	@FindBy(xpath="//h4[@class='card-title']")WebElement footerText;
	@FindBy(xpath="//a[contains(@href,'edit=1')]")WebElement buttonPrimary;
	@FindBy(xpath="//h3[@class='card-title']")WebElement footerTextInfo;
	@FindBy(xpath="//textarea[@id='content']")WebElement textareaAddress;
	@FindBy(xpath="//input[@id='email']")WebElement emailAddress;
	@FindBy(xpath="//input[@id='phone']")WebElement phoneNumber;
	@FindBy(xpath="//button[@name='Update']")WebElement buttonUpdate;
