...
public class ManageContactPage {
	...
	@FindBy(xpath="//a[contains(@href,'list-contact') and contains(@class,'nav-link')]")WebElement buttonMoreInfo;
	@FindBy(xpath="//h4[contains(@class,'card-title')]")WebElement contactUsText;
	@FindBy(xpath="//a[contains(@class,'btncss')]")WebElement buttonPrimary;
	@FindBy(xpath="//input[@id='phone']")WebElement phoneNumber;
	@FindBy(xpath="//input[@id='email']")WebElement emailAddress;
	@FindBy(xpath="//textarea[@name='address']")WebElement textareaAddress;
